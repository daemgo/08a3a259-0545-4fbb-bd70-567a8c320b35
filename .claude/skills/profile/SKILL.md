---
name: profile
description: 基于客户名称初始化 楔子科技 项目，生成客户档案 profile.json
metadata:
  short-description: 初始化 楔子科技 项目并生成客户档案
  dependencies:
...
这个 skill 用于初始化 楔子科技 项目，基于客户名称自动生成客户档案文件 `docs/customer/profile.json`。
